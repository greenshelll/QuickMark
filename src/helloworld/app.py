...
class Home:
    ...
    def add_sheet(self, *args):
        ...
        # Convert the formatted datetime string to an integer
        combined_datetime_int = int(formatted_datetime)
        self.main.record[combined_datetime_int] = {'name':'Untitled'}
    ...
    def startup(self):
        ...
        try:
            ...
            try:
                ...
                pass
        self.record = {} #reset (for debugging)
        self.update_record()
